...
namespace wcf_chat
{
    ...
    public partial class JuegoLoterestEntitiesApp : DbContext
    {
        public JuegoLoterestEntitiesApp()
            : base("name=JuegoLoterestEntitiesApp")
        {
        }
        ...
        public virtual DbSet<Tablero> Tableroes { get; set; }
